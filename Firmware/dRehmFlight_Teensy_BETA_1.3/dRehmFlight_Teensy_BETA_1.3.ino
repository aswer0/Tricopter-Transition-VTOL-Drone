...
//SWAPPED channels around bc stick bind is different on my transmitter
int rawCh1Pin = 15; //throttle
int rawCh2Pin = 16; //ail
int rawCh3Pin = 17; //ele
int rawCh4Pin = 20; //rudd

const int ch1Pin = rawCh3Pin; //throttle
const int ch2Pin = rawCh1Pin; //ail
const int ch3Pin = rawCh2Pin; //ele
const int ch4Pin = rawCh4Pin; //rudd
...
void setup() {
  ...
  servo1.attach(servo1Pin, SERVO1_MIN, SERVO1_MAX); //Pin, min PWM value, max PWM value
  servo2.attach(servo2Pin, SERVO2_MIN, SERVO2_MAX);
...
void controlMixer() {
  ...
  s2_command_scaled = SERVO2_VERTICAL_CENTER - yaw_PID; //Front right servo
}
